...
class WoocommerceUtil extends Util
{
    ...
    /* دالة syncProducts: مجمع البيانات الرئيسي
    لمزامنة المتسلسلة: قبل البدء بالمنتجات، تستدعي syncCategories و 
    syncVariationAttributes. لماذا؟ لتضمن أن القسم (Category) والمواصفات 
    (Attributes مثل اللون/المقاس) موجودة مسبقاً في ووكومرس، حتى تستطيع ربط المنتج بها.
    يقوم بجمع كافة الـ Attributes (مثل: أحمر، XL) ويحولها إلى تنسيق يفهمه ووكومرس في مصفوفة variation_attr_data-
    */
