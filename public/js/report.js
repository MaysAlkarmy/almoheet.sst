    ...
    if ($('table#product_sell_report_table').length == 1) {
        ...
        product_sell_report = $('table#product_sell_report_table').DataTable({
            ...
            columns: [
                ...
                { data: 'purchase_price', name: 'v.default_purchase_price' },  //// add column purchase price
            ...
            fnDrawCallback: function(oSettings) {
                // مجموع العامود الجديد (سعر الشراء)
                $('#footer_purchase_price').text(
                    sum_table_col($('#product_sell_report_table'), 'purchase_price')
                     );
                $('#footer_subtotal').text(
